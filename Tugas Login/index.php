...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      ...
      <a href="./registration.php"><button type="button" class="btn btn-info" href="./login.php" style="font-size:20px ;">Register</button></a>
      </span>
    </div>
  </div>
</nav>
    ...
    <div class="landing-page">
        <div class="landing-left">
            ...
            <a href="./registration.php"><button type="button" class="btn btn-info login" style="font-size:20px ;">Join Now!</button></a> 
        </div>
